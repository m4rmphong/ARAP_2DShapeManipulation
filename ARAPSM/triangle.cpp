...
/*    described in Jonathan Richard Shewchuk, "Adaptive Precision doubleing-  */
...
/*    Adaptive doubleing-Point Geometric Predicates," Proceedings of the      */
...
/*    Douglas M. Priest, "Algorithms for Arbitrary Precision doubleing Point  */
...
/*   of a doubleing exception due to overflow.  Finally, it is much faster    */
...
/*   use of internal extended precision doubleing-point registers.  The best  */
/*   way to solve this problem is to set the doubleing-point registers to use */
...
/*   doubleing-Point Arithmetic and Fast Robust Geometric Predicates" (also   */
...
/*  doubleing-point attributes, and an optional area constraint.  The latter  */
...
/*                                                                           */
/*  Vertices are relatively simple.  A vertex is a list of doubleing-point    */
/*  numbers, starting with the x, and y coordinates, followed by an          */
/*  arbitrary number of optional user-defined doubleing-point attributes,     */
...
/*   and/or a doubleing-point "area constraint."  It may also contain extra   */
...
REAL epsilon;                             /* doubleing-point machine epsilon. */
REAL resulterrbound;
...
void info()
{
	...
	printf(
		"        avoid problems associated with insufficient doubleing-point\n");
	printf("        precision.\n");
	printf(
	...
	printf(
		"    -A  Assigns an additional doubleing-point attribute to each triangle\n");
	printf(
	...
	printf(
		"    -X  No exact arithmetic.  Normally, Triangle uses exact doubleing-point\n"
		);
	printf(
	...
	printf(
		"        triangulation algorithms, despite doubleing-point roundoff error.\n");
	printf(
	...
	printf("\n");
	printf(
		"    The attributes, which are typically doubleing-point values of physical\n");
	printf(
	...
	printf(
		"    the triangulation--as long as your machine's doubleing-point precision\n");
	printf(
	...
	printf(
		"    out where the intersection point is.  Thanks to doubleing-point roundoff\n"
		);
	printf(
	...
	printf(
		"    The `direction' is a doubleing-point vector that indicates the direction\n"
		);
	...
	printf(
		"  geometers call the `orientation' and `incircle' tests.  If the doubleing-\n"
		);
	printf(
	...
	printf(
		"  doubleing-point registers, then your output is guaranteed to be an\n");
	printf(
	...
	printf(
		"  doubleing-point registers.  These must be reconfigured so their precision\n"
		);
	printf(
	...
	printf(
		"  being performed exactly, while overflow typically causes a doubleing\n");
	printf("  exception.\n\n");
	...
	printf(
		"    between 6247133 and 6247134, you're not leaving much doubleing-point\n");
	...
	printf(
		"    doubleing exception due to overflow when attempting to perform an\n");
	printf(
	...
	printf("    doubleing-point precision.\n\n");
	printf(
	...
	printf(
		"    to doubleing-point roundoff error.  Although these errors are rare,\n");
	printf(
...
/*  collection of words, and either pointers or doubleing-point values are    */
...
/*   described in detail in my paper, "Adaptive Precision doubleing-Point     */
...
/*  doubleing-point arithmetic.  `epsilon' bounds the relative roundoff       */
/*  error.  It is used for doubleing-point error analysis.                    */
/*                                                                           */
/*  `splitter' is used to split doubleing-point numbers into two half-        */
/*  length significands for exact multiplication.                            */
/*                                                                           */
/*  I imagine that a highly optimizing compiler might be too smart for its   */
/*  own good, and somehow cause this routine to fail, if it pretends that    */
/*  doubleing-point arithmetic is too much like real arithmetic.              */
/*                                                                           */
...
/*  the mesh due to doubleing-point roundoff error.  It also occurs when      */
...

{
	...
	while (1) {
		...
		/*   doubleing-point roundoff or some such bogey causes us to walk  */
				...
				(eorg == encloop->subsegorg) && (edest == encloop->subsegdest)) {
					...
					if (((newvertex[0] == eorg[0]) && (newvertex[1] == eorg[1])) ||
						((newvertex[0] == edest[0]) && (newvertex[1] == edest[1]))) {
							...
							printf("  doubleing point arithmetic.\n");
							precisionerror();
							triexit(1);
					}
	...
	if (!deadtri(badotri.tri) && (borg == badtri->triangorg) &&
		(bdest == badtri->triangdest) && (bapex == badtri->triangapex)) {
			...
			if (errorflag) {
				...
				printf("  precision of doubleing point arithmetic.  (You can be\n");
